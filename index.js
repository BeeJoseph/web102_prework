...
const descriptionString = `A total of $${totalPledged.toLocaleString()} has been raised for ${GAMES_JSON.length} games. There ${unfundedCount === 1 ? 'is' : 'are'} ${unfundedCount} unfunded ${unfundedCount === 1 ? 'game' : 'games'}.`;
